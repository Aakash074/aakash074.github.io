...
class Component extends React.PureComponent {
  ...
  enter() {
    ...
    const scaleGroup1 =
      shapesGroup1[0].getTotalLength() / this.element.offsetWidth;
    ...
    const scaleGroup2 =
      shapesGroup2[0].getTotalLength() / this.element.offsetWidth;
    ...
    const scaleGroup3 =
      shapesGroup3[0].getTotalLength() / this.element.offsetWidth;
  ...
  render() {
    const { theme, classes, energy, audio, sounds, className, ...etc } =
      this.props;
